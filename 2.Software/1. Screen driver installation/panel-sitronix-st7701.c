...
static void ts8550b_gip_sequence(struct st7701 *st7701)
{
	...
	st7701_switch_cmd_bkx(st7701, true, 0);
	//ST7701_WRITE(st7701, 0xC7, 0x04); //反180
	ST7701_WRITE(st7701, 0xCC, 0x10);

	st7701_switch_cmd_bkx(st7701, true, 1);

	ST7701_WRITE(st7701, 0xE0, 0x00, 0x00, 0x02);
	ST7701_WRITE(st7701, 0xE1, 0x06, 0xA0, 0x08, 0xA0, 0x05, 0xA0, 0x07, 0xA0, 0x00, 0x44, 0x44);
	ST7701_WRITE(st7701, 0xE2, 0x30, 0x30, 0x44, 0x44, 0x6E, 0xA0, 0x00, 0x00, 0x6E, 0xA0, 0x00, 0x00);
	ST7701_WRITE(st7701, 0xE3, 0x00, 0x00, 0x33, 0x33);
	ST7701_WRITE(st7701, 0xE4, 0x44, 0x44);
	ST7701_WRITE(st7701, 0xE5, 0x0D, 0x69, 0x0A, 0xA0, 0x0F, 0x6B, 0x0A, 0xA0, 0x09, 0x65, 0x0A, 0xA0, 0x0B, 0x67, 0x0A, 0xA0);
	ST7701_WRITE(st7701, 0xE6, 0x00, 0x00, 0x33, 0x33);
	ST7701_WRITE(st7701, 0xE7, 0x44, 0x44);
	ST7701_WRITE(st7701, 0xE8, 0x0C, 0x68, 0x0A, 0xA0, 0x0E, 0x6A, 0x0A, 0xA0, 0x08, 0x64, 0x0A, 0xA0, 0x0A, 0x66, 0x0A, 0xA0);
	ST7701_WRITE(st7701, 0xE9, 0x36, 0x00);
	ST7701_WRITE(st7701, 0xEB, 0x00, 0x01, 0xE4, 0xE4, 0x44, 0x88, 0x40);
	ST7701_WRITE(st7701, 0xED, 0xFF, 0x45, 0x67, 0xFA, 0x01, 0x2B, 0xCF, 0xFF, 0xFF, 0xFC, 0xB2, 0x10, 0xAF, 0x76, 0x54, 0xFF);
	ST7701_WRITE(st7701, 0xEF, 0x10, 0x0D, 0x04, 0x08, 0x3F, 0x1F);

	st7701_switch_cmd_bkx(st7701, false, 0);				// Common Table 1
	// ST7701_WRITE(st7701, MIPI_DCS_SET_ADDRESS_MODE, 0x00);	// 0X36
	ST7701_WRITE(st7701, MIPI_DCS_SET_PIXEL_FORMAT, 0x70);	// 0X3A
	ST7701_WRITE(st7701, MIPI_DCS_EXIT_SLEEP_MODE, 0x11);	// 0X11
	msleep(800);
	ST7701_WRITE(st7701, MIPI_DCS_SET_DISPLAY_ON, 0x29);	// 0X29
	msleep(200);
}
...
static void rg_arc_gip_sequence(struct st7701 *st7701)
{
	...
	st7701_switch_cmd_bkx(st7701, true, 0);
	// ST7701_WRITE(st7701, 0xC7, 0x04);		//X轴反向扫描
	ST7701_WRITE(st7701, 0xCC, 0x10);

	st7701_switch_cmd_bkx(st7701, true, 1);
	ST7701_WRITE(st7701, 0xBB, 0x33);	//Power pumping clk selection 2
	ST7701_WRITE(st7701, 0xBC, 0x33);	//Power pumping clk selection 3
	ST7701_WRITE(st7701, 0xE0, 0x00, 0x00, 0x02);
	ST7701_WRITE(st7701, 0xE1, 0x03, 0xA0, 0x00, 0x00, 0x02, 0xA0, 0x00, 0x00, 0x00, 0x33, 0x33);
	ST7701_WRITE(st7701, 0xE2, 0x22, 0x22, 0x33, 0x33, 0x88, 0xA0, 0x00, 0x00, 0x87, 0xA0, 0x00, 0x00);
	ST7701_WRITE(st7701, 0xE3, 0x00, 0x00, 0x22, 0x22);
	ST7701_WRITE(st7701, 0xE4, 0x44, 0x44);
	ST7701_WRITE(st7701, 0xE5, 0x04, 0x84, 0xA0, 0xA0, 0x06, 0x86, 0xA0, 0xA0, 0x08, 0x88, 0xA0, 0xA0, 0x0A, 0x8A, 0xA0, 0xA0);
	ST7701_WRITE(st7701, 0xE6, 0x00, 0x00, 0x22, 0x22);
	ST7701_WRITE(st7701, 0xE7, 0x44, 0x44);
	ST7701_WRITE(st7701, 0xE8, 0x03, 0x83, 0xA0, 0xA0, 0x05, 0x85, 0xA0, 0xA0, 0x07, 0x87, 0xA0, 0xA0, 0x09, 0x89, 0xA0, 0xA0);
	ST7701_WRITE(st7701, 0xEB, 0x00, 0x01, 0xE4, 0xE4, 0x88, 0x00, 0x40);
	ST7701_WRITE(st7701, 0xEC, 0x3C, 0x01);
	ST7701_WRITE(st7701, 0xED, 0xAB, 0x89, 0x76, 0x54, 0x02, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x20, 0x45, 0x67, 0x98, 0xBA);
	// ST7701_WRITE(st7701, 0xED, 0xBA, 0x98, 0x67, 0x45, 0x20, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x02, 0x54, 0x76, 0x89, 0xAB);
	ST7701_WRITE(st7701, 0xEF, 0x10, 0x0D, 0x04, 0x08, 0x3F, 0x1F);
	...
	st7701_switch_cmd_bkx(st7701, false, 0);				// Common Table 1
	// ST7701_WRITE(st7701, 0x36, 0x10);		//配合反扫
	ST7701_WRITE(st7701, MIPI_DCS_EXIT_SLEEP_MODE, 0x11);	// 0X11
	msleep(200);
...
static const struct drm_display_mode ts8550b_mode = {
	...
	.hdisplay	= 480,
	.hsync_start= 480 + /* HFP */ 7,
	.hsync_end	= 480 + 7 + /* HSync */ 2,
	.htotal		= 480 + 7 + 2 + /* HBP */ 11,

	.vdisplay	= 854,
	.vsync_start= 854 + /* VFP */ 12,
	.vsync_end	= 854 + 12 + /* VSync */ 2,
	.vtotal		= 854 + 12 + 2 + /* VBP */ 16,
...
static const struct st7701_panel_desc ts8550b_desc = {
	...
	.pv_gamma = {
		...
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC0_MASK, 0x07),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_AJ_MASK, 0) |
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC4_MASK, 0x14),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_AJ_MASK, 0) |
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC8_MASK, 0x9C),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC16_MASK, 0x0B),
		...
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_AJ_MASK, 0) |
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC231_MASK, 0x4F),

		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC239_MASK, 0x0E),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_AJ_MASK, 0) |
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC247_MASK, 0x66),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_AJ_MASK, 0) |
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC251_MASK, 0x2D),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_AJ_MASK, 0) |
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC255_MASK, 0x1C)
	},
	.nv_gamma = {
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_AJ_MASK, 0) |
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC0_MASK, 0X09),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_AJ_MASK, 0) |
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC4_MASK, 0x17),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_AJ_MASK, 0) |
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC8_MASK, 0x9E),
		...
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_AJ_MASK, 0) |
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC231_MASK, 0x51),

		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC239_MASK, 0x10),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_AJ_MASK, 0) |
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC247_MASK, 0x6A),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_AJ_MASK, 0) |
	...
	.nlinv = 1,				//BK0 - C2: 01h
	.vop_uv = 4500000,		//BK1 - B0
	.vcom_uv = 937500,		//BK1 - B1	
	.vgh_mv = 13500,		//BK1 - B2
	.vgl_mv = -8920,		//BK1 - B5
	.avdd_mv = 6800,		//BK1 - B8
	.avcl_mv = -5000,		//BK1 - B8
	.gamma_op_bias = OP_BIAS_MIDDLE,	//BK1 - B7
	.input_op_bias = OP_BIAS_MIN,		//BK1 - B7
	.output_op_bias = OP_BIAS_MIN,		//BK1 - B7
	.t2d_ns = 1600,			//BK1 - C1
	.t3d_ns = 6400,			//BK1 - C2
	.eot_en = true,			//BK1 - D0
...
static const struct st7701_panel_desc rg_arc_desc = {
	...
	.pv_gamma = {
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_AJ_MASK, 0) |
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC0_MASK, 0x00),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_AJ_MASK, 0) |
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC4_MASK, 0x0A),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_AJ_MASK, 0) |
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC8_MASK, 0x11),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC16_MASK, 0x0C),

		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_AJ_MASK, 0) |
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC24_MASK, 0x10),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC52_MASK, 0x05),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC80_MASK, 0x00),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC108_MASK, 0x08),

		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC147_MASK, 0x08),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC175_MASK, 0x1F),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC203_MASK, 0x07),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_AJ_MASK, 0) |
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC231_MASK, 0x13),

		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC239_MASK, 0x10),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_AJ_MASK, 0) |
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC247_MASK, 0xA9),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_AJ_MASK, 0) |
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC251_MASK, 0x30),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_AJ_MASK, 0) |
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC255_MASK, 0x18)
	...
	.nv_gamma = {
		...
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC0_MASK, 0),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_AJ_MASK, 0) |
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC4_MASK, 0x0B),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_AJ_MASK, 0) |
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC8_MASK, 0x11),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC16_MASK, 0x0D),

		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_AJ_MASK, 0) |
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC24_MASK, 0x0F),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC52_MASK, 0x05),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC80_MASK, 0x02),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC108_MASK, 0x07),

		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC147_MASK, 0x06),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC175_MASK, 0x20),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC203_MASK, 0x05),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_AJ_MASK, 0) |
	...
	.nlinv = 1,				//BK0 - C2: 01h
	.vop_uv = 4575000,		//BK1 - B0
	.vcom_uv = 1300000,		//BK1 - B1	
	.vgh_mv = 15000,		//BK1 - B2
	.vgl_mv = -10170,		//BK1 - B5
	.avdd_mv = 6600,		//BK1 - B8
	.avcl_mv = -4600,		//BK1 - B8
